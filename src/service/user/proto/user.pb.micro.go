...
func (c *userService) SendSms(ctx context.Context, in *SendSmsRequest, opts ...client.CallOption) (*SendSmsResponse, error) {
...
func (h *userHandler) SendSms(ctx context.Context, in *SendSmsRequest, out *SendSmsResponse) error {
